        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div class="flex items-center gap-3">
            ...
            <button @click="$emit('auto-calculate')"
                    type="button"
                    class="px-4 py-2 text-sm bg-green-950 text-green-100 rounded-lg hover:bg-green-700 transition-colors">
              Auto-calcul
            </button>
          </div>
        </div>
            ...
            <div class="flex items-start gap-3">
              ...
              <div class="flex items-center h-6 pt-1">
                <input :id="`oil-${oil.name}`"
                       ...
                       class="h-5 w-5 rounded border-2 border-gray-300 checked:border-green-600 checked:bg-green-600 focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:opacity-50"
                  ...
                  <div>
                    <label :for="`oil-${oil.name}`"
                           :class="[
                             ...
                             oil.selected ? 'text-gray-900 hover:text-green-600' : 'text-gray-700'
                           ]">
                      {{ oil.name }}
                    </label>
                ...
                <div v-if="oil.selected" class="mt-4 space-y-3">
                  ...
                  <div class="space-y-1">
                    <div class="flex justify-between text-xs">
                      ...
                      <span class="text-green-600 font-medium">Recommandé</span>
      ...
      <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex items-center gap-3">
          <div :class="[
            ...
            {{ oilPhaseExceeded ? '?? Dépassement' : '? Dans la limite' }}
          </div>
          ...
          <div class="relative">
            ...
            <div class="h-6 bg-gradient-to-r from-gray-200 to-gray-300 rounded-full overflow-hidden mb-2">
              <div class="h-full rounded-full transition-all duration-1000"
                   :class="oilPhaseExceeded ? 'bg-gradient-to-r from-red-500 to-orange-500' : 'bg-gradient-to-r from-green-500 to-emerald-500'"
            ...
            <div class="flex justify-between text-sm mb-6">
              ...
              <span class="font-bold" :class="oilPhaseExceeded ? 'text-red-600' : 'text-green-600'">
              ...
              <div v-for="item in selectedOilPhase"
                ...
                <div class="flex justify-between items-center mb-1">
                  <div class="flex items-center gap-2">
                    ...
                    <span :class="[
                      ...
                      item.comedogenic <= 2 ? 'bg-green-100 text-green-800' :
                      'bg-red-100 text-red-800'
                    ]">
                ...
                <div class="text-xs text-gray-500 flex justify-between">
                  ...
                  <span class="text-green-600">{{
                      ((item.percent / oilPhaseTotal) * 100).toFixed(0)
                    }}% de la phase</span>
                </div>
              </div>
            </div>
          ...
          <div class="mt-6 pt-6 border-t border-green-200">
            <div class="flex justify-between items-center">
              ...
              <div class="text-right">
                <span :class="[
                  'text-2xl font-bold',
                  oilPhaseExceeded ? 'text-red-600' : 'text-green-700'
                ]">
                  {{ oilPhaseTotal.toFixed(1) }}%
                </span>
