        ...
        <div class="space-y-6">
            ...
            <span class="p-2 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg text-white">
              ...
              ({{ category.items.filter(i => i.selected).length }}/{{ category.items.length }})
                    ...
                    <button @click="$emit('toggle-category', category, 'aqueous')"
                            type="button"
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex items-center h-6 pt-1">
                                <input :id="`aq-${hydrosol.name}`"
                                       ...
                                       @change="$emit('update-aqueous-phase', catName, hydrosol.name, { selected: hydrosol.selected })">
                            </div>
                                        ...
                                        <div class="flex items-center gap-2">
                                            <div class="relative flex-1">
                                                <input :id="`aq-percent-${hydrosol.name}`"
                                                       ...
                                                       @change="$emit('update-aqueous-phase', catName, hydrosol.name, { percent: hydrosol.percent })">
